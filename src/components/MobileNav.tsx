    ...
    <div className="block md:hidden fixed bottom-0 left-0 right-0">
      <div className="flex text-gray-700 dark:text-gray-300 *:flex *:items-center">
        ...
        <div
          ...
          <Link href="/browse" className={pathname === "/browse" ? "text-ig-red dark:text-ig-orange" : ""}>
            <LayoutGridIcon />
          </Link>
          <Link href="/profile" className={pathname === "/profile" ? "text-ig-red dark:text-ig-orange" : ""}>
            <UserIcon />
          </Link>
        </div>
      </div>
